...
`+t,"error"))});let n=null;function o(){e.invoke("getRunTime")}e.on("cnBetaSubscribe",function(t){var o=[];if(t.hasOwnProperty("progressValues")&&Array.isArray(t.progressValues))for(let e=0;e<t.progressValues.length;e++){var a=(100*t.progressValues[e]).toFixed(2);o.push(parseFloat(a))}switch(null==n?n=notification.show({title:"CnBeta发布",content:t.message,bars:o}):(notification.setContent(n,t.message),notification.setProgress(n,o)),t.type){case 0:outPutSuccess(t.message);break;case 1:outPutInfo(t.message);break;case 2:outPutError(t.message);break;case 3:outPutSuccess(t.message),setTimeout(function(){notification.close(n),n=null},1e3)}}),e.on("ready",function(e){console.info(e)}),setTimeout(function(){o()},1e3),e.on("ReceiveRunTime",function(e){var t=$("#runTime");0<t.length&&(t.text("运行时间 "+e),setTimeout(o,1e3))}),e.on("systemNotification",function(e){layer.msg(e)})})(),(async()=>{var e=(new signalR.HubConnectionBuilder).withUrl("/app/notification",{skipNegotiation:!0,transport:signalR.HttpTransportType.WebSockets}).withAutomaticReconnect().build();try{await e.start()}catch(e){console.error(e)}e.on("systemMessage",function(e,t){0===e?(outPutSuccess(t),$.notify(t,"success")):1===e?(outPutInfo(t),$.notify(t,"warn")):2===e&&(outPutError(t),$.notify(t,"error"))})})();let notification={_instances:new Set,show:function(e){var e={title:"",content:"",bars:[],autoClose:0,type:"info",...e=e&&"object"==typeof e?e:{}},t=this._calculateTopPosition();let o=this._createBox(e);return o.css("top",t+"px"),$("body").append(o),this._instances.add(o[0]),0<e.autoClose&&setTimeout(()=>this.close(o),e.autoClose),requestAnimationFrame(()=>{o.addClass("notification-enter")}),o},setContent:function(e,t){this._validateBox(e)&&0<(e=e.find(".content")).length&&e.text(String(t||""))},setTitle:function(e,t){this._validateBox(e)&&0<(e=e.find(".title")).length&&e.text(String(t||""))},setProgress:function(e,t){if(this._validateBox(e)&&Array.isArray(t)){let o=e.find(".content-container .progress .bar");t.forEach((e,t)=>{"number"==typeof e&&t<o.length&&(e=Math.max(0,Math.min(100,e)),o.eq(t).css("width",e+"%").text(e.toFixed(1)+"%"))})}},close:function(e){this._validateBox(e)&&(e.addClass("notification-exit"),setTimeout(()=>{e[0]&&(this._instances.delete(e[0]),e.remove(),this._recalculatePositions())},300))},closeAll:function(){Array.from(this._instances).forEach(e=>{e=$(e);0<e.length&&this.close(e)})},getActiveCount:function(){return this._instances.size},test:function(){let e=this.show({title:"测试通知",content:"正在加载...",bars:[0],type:"info"}),t=0,o=setInterval(()=>{100<=t?(this.setContent(e,"加载完毕，即将关闭！"),clearInterval(o),setTimeout(()=>this.close(e),1e3)):(t+=2,this.setContent(e,`进度: ${t}%`),this.setProgress(e,[t]))},50)},_validateBox:function(e){return e&&0<e.length&&this._instances.has(e[0])},_calculateTopPosition:function(){let t=15;return this._instances.forEach(e=>{e=$(e);e.is(":visible")&&(t+=e.outerHeight(!0)+15)}),t},_recalculatePositions:function(){let t=15;this._instances.forEach(e=>{e=$(e);e.is(":visible")&&(e.css("top",t+"px"),t+=e.outerHeight(!0)+15)})},_createBox:function(e){var t=$("<div>").addClass("notification-box notification-"+e.type),o=(e.title&&(o=$("<div>").addClass("title").text(e.title),t.append(o)),$("<div>").addClass("content-container")),a=$("<div>").addClass("content").text(e.content);return o.append(a),this._createProgressBars(o,e.bars),t.append(o),this._addCloseButton(t),t},_createProgressBars:function(o,e){Array.isArray(e)&&0!==e.length&&e.forEach(e=>{var t;"number"==typeof e&&(e=Math.max(0,Math.min(100,e)),t=$("<div>").addClass("progress"),e=$("<div>").addClass("bar").css("width",e+"%").text(e.toFixed(1)+"%"),t.append(e),o.append(t))})},_addCloseButton:function(t){var e=$("<button>").addClass("notification-close").html("&times;").attr("aria-label","关闭通知").on("click",e=>{e.preventDefault(),e.stopPropagation(),this.close(t)});t.append(e)}},layImConfig=((()=>{function e(){$(".bookmark-item .bookmark-card").each(function(){var e=$(this),t=e.children("img").filter(":not(.bookmark-icon)"),o=e.find("img[data-src]:not(.bookmark-icon)");0<t.length||0<o.length?e.removeClass("no-image"):e.addClass("no-image")})}$(document).ready(function(){e()}),$(document).on("pjax:complete",function(){setTimeout(e,100)}),$(document).on("load",".bookmark-card img:not(.bookmark-icon)",function(){e()}),$(document).on("lazyloaded",".bookmark-card img:not(.bookmark-icon)",function(){e()});let n="";$(document).delegate(".bookmark .search-box input[type=search]","input",function(){n=$(this).val();let e=[];$(".bookmark .category-box .category.active").each(function(){e.push($(this).text())}),$.ajax({type:"get",url:"/bookmark/search",traditional:!0,data:{title:n,categories:e}}).done(function(e){if(e.success){$(".bookmark .search-box .search-result").show();var t,o=[];for(t of e.data)o.push(`<li>${t}</li>`);$(".bookmark .search-box .search-result ul").html(o.join(""))}})}),$(document).delegate(".bookmark .search-box input[type=search]","keyup",function(t){if(13===t.keyCode){t=$(this).val();let e=[];$(".bookmark .category-box .category.active").each(function(){e.push("categories="+encodeURIComponent($(this).text()))}),""===t.trim()&&0===e.length?$.pjax({url:"/bookmark.html",container:".blog-body"}):""===t.trim()&&0!==e.length?$.pjax({url:"/bookmark.html?"+e.join("&"),container:".blog-body"}):""!==t.trim()&&0===e.length?$.pjax({url:"/bookmark.html?title="+encodeURIComponent(t),container:".blog-body"}):$.pjax({url:`/bookmark.html?title=${encodeURIComponent(t)}&`+e.join("&"),container:".blog-body"})}}),$(document).delegate(".bookmark .search-box .search-result ul li","click",function(){var e=$(this).text();let t=[];$(".bookmark .category-box .category.active").each(function(){t.push("categories="+encodeURIComponent($(this).text()))}),0===t.length?$.pjax({url:"/bookmark.html?title="+encodeURIComponent(e),container:".blog-body"}):$.pjax({url:`/bookmark.html?title=${encodeURIComponent(e)}&`+t.join("&"),container:".blog-body"})}),$(document).delegate(".bookmark .search-box input[type=search]","blur",function(){setTimeout(function(){$(".bookmark .search-box .search-result").hide()},300)}),$(document).delegate(".bookmark .search-box input[type=search]","focus ",function(){0<$(".bookmark .search-box .search-result ul li").length&&$(".bookmark .search-box .search-result").show()}),$(document).delegate(".bookmark .search-box input[type=search]","keydown",function(e){var t,o=$(".bookmark .search-box .search-result ul li"),a=$(".bookmark .search-box .search-result ul li.selected");40===e.keyCode?(e.preventDefault(),0===a.length?((t=o.first()).addClass("selected"),$(this).val(t.text())):$(".bookmark .search-box .search-result ul li:last").hasClass("selected")?(o.removeClass("selected"),$(this).val(n)):(t=a.next(),o.removeClass("selected"),0<t.length&&(t.addClass("selected"),$(this).val(t.text())))):38===e.keyCode&&(e.preventDefault(),0===a.length?((t=o.last()).addClass("selected"),$(this).val(t.text())):$(".bookmark .search-box .search-result ul li:first").hasClass("selected")?(o.removeClass("selected"),$(this).val(n)):(e=a.prev(),o.removeClass("selected"),0<e.length&&(e.addClass("selected"),$(this).val(e.text()))))}),$(document).delegate(".bookmark .category-box .category","click",function(){$(this).hasClass("active")?$(this).removeClass("active"):$(this).addClass("active")}),$(document).delegate("form.bookmark-create","submit",function(){var e=new FormData(this);let a=$(this);return $(this).find("button[lay-submit]").addClass("layui-btn-disabled").attr("disabled","disabled").html('<i class="layui-icon layui-icon-loading layui-anim layui-anim-rotate layui-anim-loop layui-font-12"></i> 正在提交'),$.ajax({url:a.attr("action"),processData:!1,contentType:!1,data:e,type:"post"}).done(function(e,t,o){e.success?(a[0].reset(),layer.closeAll(),$.pjax({url:"/bookmark.html",container:".blog-body"})):layer.alert(e.msg)}).fail(ajaxFail),!1}),layui.use(["element","layer","carousel","util","flow","form","upload"],function(){let a=layui.form;$(document).delegate(".bookmark-setting[data-id]","click",function(){var e=$(this).data("id");let t=layer.load(),o=600<$(window).width()?"600px":"100%";$.ajax({url:"/bookmark/update/"+e,type:"get"}).done(function(e){"object"==typeof e?e.success||layer.msg(e.msg):layer.open({type:1,content:e,area:o,success:function(){a.render()}})}).always(function(){layer.close(t)}).fail(ajaxFail)})}),$(document).delegate("form.bookmark-create button[data-delete]","click",function(){let e=layer.load();$.ajax({url:"/bookmark/delete",type:"post",data:{id:$(this).data("delete")}}).done(function(){layer.closeAll(),$.pjax({url:"/bookmark.html",container:".blog-body"})}).always(function(){layer.close(e)})})})(),(()=>{var e;function c(e,t){var o={loading:{class:"ds-button-loading",disabled:!0,html:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        `,document.head.appendChild(e))}function initSteamAchievements(){var e=$(".category-toggle");0!==e.length&&e.each(function(){var e=$(this),t=e.closest(".achievement-category-section"),o=t.attr("data-category"),a=localStorage.getItem("steam-achievements-"+o),t=t.find(".category-content"),n=e.find(".toggle-icon");null!==a?"collapsed"===a?(t.addClass("collapsed"),e.addClass("collapsed"),n.removeClass("layui-icon-down").addClass("layui-icon-right")):(t.removeClass("collapsed"),e.removeClass("collapsed"),n.removeClass("layui-icon-right").addClass("layui-icon-down")):"unlocked"===o?(t.removeClass("collapsed"),e.removeClass("collapsed"),n.removeClass("layui-icon-right").addClass("layui-icon-down"),localStorage.setItem("steam-achievements-"+o,"expanded")):(t.addClass("collapsed"),e.addClass("collapsed"),n.removeClass("layui-icon-down").addClass("layui-icon-right"),localStorage.setItem("steam-achievements-"+o,"collapsed"))})}layui.config({layimPath:dpzOption.CDNBaseAddress+"/lib/layim/",layimResPath:dpzOption.CDNBaseAddress+"/lib/layim/res/"}).extend({layim:dpzOption.CDNBaseAddress+"/lib/layim/layim"}).use(["layim","layer"],async function(){if(!0!==layui.device().mobile){let t=layui.layim,a=layui.layer,n=(t.callback("contentParser",e=>{e=$("<div>").html(e),e=$("<div>").text(e.html()).html(),e=converter.makeHtml(e),e=$(`<div><div class="markdown-body">${e}</div></div>`);return e.find("pre code").each(function(e,t){console.log(t),$(t).parents("pre").attr("style","padding:1em !important;"),Prism.highlightElement(t);t=$(t);t.replaceWith("<div>"+t.html()+"</div>")}),e.html()}),t.config(layImConfig),t.extendChatTools(chatTools),t.on("sign",async function(e){try{var t=new FormData;t.append("sign",e);var o=await(await fetch("/Account/UpdateSign",{method:"POST",body:t})).json();o.success||a.msg(o.msg)}catch(e){console.error(e)}}),await getSignalRConnection("/chatHub")),i=await getSignalRConnection("/robotChat");n.on("ReceiveMessage",function(e){e.timestamp=1e3*e.timestamp,t.getMessage(e)}),i.on("Answer",function(e){console.log(e),t.getMessage(e)}),i.on("SystemError",function(e){console.error(e),t.getMessage(e)}),n.on("System",function(e){e.code<0?(outPutError(e.content),n.stop()):0!==e.code||e.isGuest?1===e.code&&(a.msg(e.user.name+"上线了"),t.setFriendStatus(e.user.id,"online")):(a.msg(e.user.name+"下线了"),t.setFriendStatus(e.user.id,"offline"))}),t.on("sendMessage",async function(e){var t=e.receiver.id,o=e.receiver.type,e=e.user.content;try{"kefu"===t&&await i.invoke("SendMessage",e),"e0a82f97-d01d-43c0-a257-97998003e8b9"===t?await i.invoke("SendMessageToChatGpt",e):"friend"===o?await n.invoke("SendMessageToUser",t,e):"group"===o&&await n.invoke("SendMessageToGroup",t,e)}catch(e){console.error(e)}}),t.on("viewMmembers",loadMembers),t.callback("chatlog",async function(e){console.log(e);e=await fetch(`/Chat/ChatRecord/${e.receiver.id}?type=`+e.receiver.type);return e.json()})}}),"loading"===document.readyState?document.addEventListener("DOMContentLoaded",function(){addShakeAnimation(),initMobileSearch()}):(addShakeAnimation(),initMobileSearch()),window.addEventListener("resize",function(){clearTimeout(window.mobileSearchResizeTimer),window.mobileSearchResizeTimer=setTimeout(function(){window.innerWidth<=768&&initMobileSearch()},250)}),$(document).delegate(".category-toggle","click",function(e){var t=$(this),o=t.closest(".achievement-category-section"),a=o.find(".category-content"),n=t.find(".toggle-icon"),o=o.attr("data-category");a.hasClass("collapsed")?(a.removeClass("collapsed"),t.removeClass("collapsed"),n.removeClass("layui-icon-right").addClass("layui-icon-down"),localStorage.setItem("steam-achievements-"+o,"expanded")):(a.addClass("collapsed"),t.addClass("collapsed"),n.removeClass("layui-icon-down").addClass("layui-icon-right"),localStorage.setItem("steam-achievements-"+o,"collapsed"))}),(()=>{let u=!1,m=!0,s=0,g=[],h=null,p=null,i=null,f=null,y=null,l=null,r=null,c=null,d={click:null,load:null,error:null,resize:null,scroll:null},v={currentPage:1,pageSize:20,totalPages:1,totalCount:0,hasNextPage:!1,pictures:[]},b=1,w=0,k=0,x=!1,C=0,E=0,S=0,M=0,T=0,P=null,Y={minScale:.5,maxScale:8,zoomStep:.2,touchZoomSensitivity:.005,wheelZoomSensitivity:.005},I={loadThreshold:200,loadDelay:500,animationDelay:100,imageQuality:.8,maxRetries:3,retryDelay:1e3,preloadCount:3};function t(){try{if("undefined"==typeof $)console.error("jQuery is required for albums page");else if(v&&v.pictures){if(p=document.getElementById("albumsLoading"),i=document.getElementById("albumsNoMore"),f=document.getElementById("albumsMasonry"),y=document.getElementById("albumsModal"),l=document.getElementById("albumsModalImage"),r=document.getElementById("albumsModalPrev"),c=document.getElementById("albumsModalNext"),P=document.querySelector(".albums-modal-image-container-v2"),!f)throw new Error("Masonry container not found");if(!y)throw new Error("Modal element not found");if(!P)throw new Error("Image container not found");var e=document.querySelector(".albums-container-v2"),t=document.querySelector("#albums-pictures-data");if(e&&t){v.currentPage=parseInt(e.dataset.currentPage)||1,v.pageSize=parseInt(e.dataset.pageSize)||20,v.totalPages=parseInt(e.dataset.totalPages)||1,v.totalCount=parseInt(e.dataset.totalCount)||0,v.hasNextPage="true"===e.dataset.hasNextPage;try{v.pictures=JSON.parse(t.value||"[]")}catch(e){console.error("Failed to parse pictures data:",e),v.pictures=[]}g=(v.pictures||[]).map(e=>({id:e.id,url:e.url,description:e.description,width:e.width,height:e.height})),m=v.hasNextPage}else console.error("Albums container not found");H(),d.click=function(t){var e=t.target.closest(".albums-view-btn, .albums-download-btn, .albums-share-btn");if(e)if(t.preventDefault(),t.stopPropagation(),e.classList.contains("albums-view-btn")){var t=e.getAttribute("data-id"),o=e.getAttribute("data-url"),a=t,t=o,n=(-1===(s=g.findIndex(e=>e.id===a))&&(s=0),t);if(y&&l){b=1,w=0,k=0,A(),B(),oe(),(t=new Image).onload=function(){l.src=n,l.classList.add("fade-in"),setTimeout(()=>{q()},200),setTimeout(()=>{l.classList.remove("fade-in")},300)},t.onerror=function(){l.src=n,q()},t.src=n,y.style.display="flex",y.classList.remove("closing"),requestAnimationFrame(()=>{y.classList.add("show")});{let t=document.querySelector(".albums-modal-close-v2"),o=document.getElementById("albumsModalPrev"),a=document.getElementById("albumsModalNext"),e=document.querySelector(".albums-modal-backdrop-v2"),n=(D(),t&&(z.closeBtn=function(e){e.preventDefault(),e.stopPropagation(),t.style.transform="scale(0.95)",setTimeout(()=>{t.style.transform=""},150),setTimeout(()=>{R()},100)},t.addEventListener("click",z.closeBtn)),null),i=(o&&(z.prevBtn=function(e){e.preventDefault(),e.stopPropagation(),n&&clearTimeout(n),o.style.transform="scale(0.95)",setTimeout(()=>{o.style.transform=""},150),n=setTimeout(()=>{j()},100)},o.addEventListener("click",z.prevBtn)),null),s=(a&&(z.nextBtn=function(e){e.preventDefault(),e.stopPropagation(),i&&clearTimeout(i),a.style.transform="scale(0.95)",setTimeout(()=>{a.style.transform=""},150),i=setTimeout(()=>{N()},100)},a.addEventListener("click",z.nextBtn)),e&&(z.backdrop=function(e){e.preventDefault(),e.stopPropagation(),R()},e.addEventListener("click",z.backdrop)),null),l=(z.keyboard=function(e){if(y&&"none"!==y.style.display)switch(s&&clearTimeout(s),e.key){case"Escape":R();break;case"ArrowLeft":s=setTimeout(()=>{j()},50);break;case"ArrowRight":s=setTimeout(()=>{N()},50)}},document.addEventListener("keydown",z.keyboard),0),r=0,c=0,d=0;z.touchStart=function(e){l=e.touches[0].clientX,r=e.touches[0].clientY},z.touchMove=function(e){e.preventDefault()},z.touchEnd=function(e){c=e.changedTouches[0].clientX,d=e.changedTouches[0].clientY;var e=c-l,t=d-r;Math.abs(e)>Math.abs(t)&&50<Math.abs(e)&&(0<e?j:N)()},y&&(y.addEventListener("touchstart",z.touchStart),y.addEventListener("touchmove",z.touchMove),y.addEventListener("touchend",z.touchEnd))}te(),ee(),document.body.style.overflow="hidden"}else console.error("Modal or modalImage not found")}else if(e.classList.contains("albums-download-btn")){o=e.getAttribute("data-url"),t=e.getAttribute("data-id");try{var i=document.createElement("a");i.href=o,i.download=`image_${t}_${Date.now()}.jpg`,i.target="_blank",i.rel="noopener noreferrer",document.body.appendChild(i),i.click(),document.body.removeChild(i),ne("图片下载开始")}catch(e){console.error("Download failed:",e),ie("下载失败，请稍后重试")}}else if(e.classList.contains("albums-share-btn")){t=e.getAttribute("data-url"),e=e.getAttribute("data-description");try{navigator.share?navigator.share({title:"分享图片",text:e||"来自相册的精美图片",url:t}):(ae(t),ne("图片链接已复制到剪贴板"))}catch(e){console.error("Share failed:",e),ae(t),ne("图片链接已复制到剪贴板")}}},document.addEventListener("click",d.click),d.load=function(e){e.target.classList.contains("albums-picture-image-v2")&&((e=e.target).style.opacity="1",e.closest(".albums-picture-card-v2").style.opacity="1",e.closest(".albums-picture-card-v2").style.transform="translateY(0)")},document.addEventListener("load",d.load,!0),d.error=function(e){var t;e.target.classList.contains("albums-picture-image-v2")&&((t=e.target).style.opacity="0.5",t.alt="图片加载失败",(e=parseInt(t.dataset.retryCount||"0"))<I.maxRetries?(t.dataset.retryCount=(e+1).toString(),setTimeout(()=>{t.src=t.src+"?retry="+Date.now()},I.retryDelay)):t.src="/core/images/image-error.png")},document.addEventListener("error",d.error,!0);{f.querySelectorAll(".albums-picture-card-v2").forEach((e,t)=>{e.style.animationDelay=t*I.animationDelay+"ms"});let e=null;d.resize=()=>{e&&clearTimeout(e),e=setTimeout(()=>{f.offsetWidth,f.querySelectorAll(".albums-picture-card-v2").forEach((e,t)=>{e.style.animationDelay=t*(I.animationDelay/2)+"ms"})},300)},window.addEventListener("resize",d.resize)}if("IntersectionObserver"in window){var o=document.createElement("div"),a=(o.id="albums-sentinel",o.style.height="1px",o.style.width="100%",o.style.position="relative",o.style.clear="both",o.style.backgroundColor="transparent",document.getElementById("albumsLoading"));a&&a.parentNode?a.parentNode.insertBefore(o,a):(document.querySelector(".albums-container-v2")||document.body).appendChild(o),(h=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&m&&!u&&_()})},{root:null,rootMargin:I.loadThreshold+"px",threshold:.01})).observe(o)}else{let e=null;d.scroll=()=>{e&&clearTimeout(e),e=setTimeout(()=>{var e,t,o;e=window.pageYOffset||document.documentElement.scrollTop,t=window.innerHeight,o=document.documentElement.scrollHeight,(o-=e+t)<=I.loadThreshold&&m&&!u&&_()},100)},window.addEventListener("scroll",d.scroll)}if(y&&P&&l&&((n=y.querySelector(".albums-modal-content-v2"))&&n.addEventListener("click",e=>{e.stopPropagation()}),P.addEventListener("wheel",J,{passive:!1}),l.addEventListener("mousedown",X),document.addEventListener("mousemove",V),document.addEventListener("mouseup",W),P.addEventListener("touchstart",G,{passive:!1}),P.addEventListener("touchmove",K,{passive:!1}),P.addEventListener("touchend",Q,{passive:!1}),l.addEventListener("dblclick",Z),ee()),"IntersectionObserver"in window){let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&((e=e.target).dataset.src&&(e.src=e.dataset.src,e.removeAttribute("data-src")),t.unobserve(e))})},{root:null,rootMargin:"50px",threshold:.1});document.querySelectorAll("img[data-src]").forEach(e=>{t.observe(e)})}document.querySelectorAll(".albums-picture-image-v2").forEach((e,t)=>{t<I.preloadCount&&((new Image).src=e.src)}),m?(L(),i&&(i.style.display="none")):(L(),F())}else console.error("Albums data not properly initialized")}catch(e){console.error("Failed to initialize albums page:",e)}var n}function H(){d.click&&(document.removeEventListener("click",d.click),d.click=null),d.load&&(document.removeEventListener("load",d.load,!0),d.load=null),d.error&&(document.removeEventListener("error",d.error,!0),d.error=null),d.resize&&(window.removeEventListener("resize",d.resize),d.resize=null),d.scroll&&(window.removeEventListener("scroll",d.scroll),d.scroll=null)}async function _(){if(!u&&m){u=!0,p&&(p.style.display="flex");try{var e=v.currentPage+1,t=await fetch(`/pages/albums?pageIndex=${e}&pageSize=`+v.pageSize);if(!t.ok)throw new Error("HTTP error! status: "+t.status);var o=await t.json(),a=(v.currentPage=o.currentPageIndex,v.hasNextPage=o.currentPageIndex<o.totalPageCount,m=o.currentPageIndex<o.totalPageCount,o.totalItemCount),n=o.currentPageIndex,i=document.getElementById("totalCount"),s=document.getElementById("currentPage");if(i&&(i.textContent=a),s&&(s.textContent=n),0<o.items.length){var l=o.items,r=document.createDocumentFragment();for(let e=0;e<l.length;e++){var c=(e=>{var t=document.createElement("div"),o=(t.className="albums-picture-card-v2",e.Id||e.id),a=e.AccessUrl||e.accessUrl,n=e.Description||e.description,i=e.Width||e.width,s=e.Height||e.height,l=e.Tags||e.tags,r=e.Creator||e.creator,c=e.Length||e.length,e=e.UploadTime||e.uploadTime,l=(t.setAttribute("data-id",o),l&&0<l.length?`<div class="albums-picture-tags-v2">
                ${l.map(e=>`<span class="ds-badge ds-badge-primary albums-tag-v2">#${e}</span>`).join("")}
               </div>`:""),d=n?`<div class="albums-picture-description-v2">
                <p class="ds-text-body">${O(n)}</p>
            ...
            <div class="albums-picture-wrapper-v2">
                ...
                <div class="albums-picture-overlay-v2">
                    <div class="albums-picture-actions-v2">
                        <button class="albums-action-btn-v2 albums-view-btn" data-id="${o}" data-url="${a}">
                            <i class="fa fa-eye"></i>
                        </button>
                        <button class="albums-action-btn-v2 albums-download-btn" data-url="${a}" data-id="${o}">
                            <i class="fa fa-download"></i>
                        </button>
                        <button class="albums-action-btn-v2 albums-share-btn" data-url="${a}" data-description="${O(n||"")}">
                ...
                <div class="albums-picture-meta-v2">
                    <div class="albums-picture-user-v2">
                        ...
                        <div class="albums-user-info-v2">
                            <span class="albums-user-name-v2">${O(r?.Name||r?.name||"")}</span>
                            <span class="albums-upload-time-v2">${(t=>{try{var e=new Date(t),o=new Date-e,a=Math.floor(o/864e5);return 0===a?"今天":1===a?"昨天":a<7?a+"天前":e.toLocaleDateString("zh-CN",{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch(e){return t}})(e)}</span>
                        </div>
                    </div>
        ...
        `,t})(l[e]);c.style.animationDelay=e*I.animationDelay+"ms",r.appendChild(c)}f.appendChild(r),await 0;var d=o.items.map(e=>({id:e.Id||e.id,url:e.AccessUrl||e.accessUrl,description:e.Description||e.description,width:e.Width||e.width,height:e.Height||e.height}));g=g.concat(d)}setTimeout(()=>{var e,t;L(),m?(t=document.getElementById("albums-sentinel"))&&(e=document.getElementById("albumsLoading"))&&e.parentNode&&t.parentNode&&t.nextSibling!==e&&e.parentNode.insertBefore(t,e):(F(),h&&(h.disconnect(),h=null),(t=document.getElementById("albums-sentinel"))&&t.parentNode&&t.parentNode.removeChild(t))},I.loadDelay)}catch(e){console.error("Failed to load more images:",e),L(),ie("加载失败，请稍后重试")}finally{u=!1}}}function L(){p&&(p.style.display="none")}function F(){i&&(i.style.display="flex")}let e=null;function J(o){o.preventDefault(),e&&clearTimeout(e),e=setTimeout(()=>{var e=P.getBoundingClientRect(),t=o.clientX-e.left,e=o.clientY-e.top;U(Math.exp(-.005*o.deltaY),t,e)},16)}function U(e,t,o){var a,n,e=Math.max(Y.minScale,Math.min(Y.maxScale,b*e));e!==b&&(a=P.getBoundingClientRect(),void 0!==t&&void 0!==o||(t=a.width/2,o=a.height/2),n=e/b,t=t-a.width/2,o=o-a.height/2,w=(w-t/b)*n+t/e,k=(k-o/b)*n+o/e,b=e,A(),B())}function A(){var e,t,o;k=b<=1?w=0:(e=P.getBoundingClientRect(),o=l.getBoundingClientRect(),t=o.width,o=o.height,t=Math.max(0,(t-e.width)/2),o=Math.max(0,(o-e.height)/2),w=Math.max(-t,Math.min(t,w)),Math.max(-o,Math.min(o,k))),l.style.transform=`translate(${w}px, ${k}px) scale(${b})`}function B(){1<b?(l.classList.add("zoomed"),P.classList.add("zoomed")):(l.classList.remove("zoomed"),P.classList.remove("zoomed"));{window.zoomIndicatorTimeout&&clearTimeout(window.zoomIndicatorTimeout);let e=document.getElementById("albums-zoom-indicator");e||((e=document.createElement("div")).id="albums-zoom-indicator",e.style.cssText=`
                position: fixed;
                top: 50%;
                left: 50%;
            ...
            `,document.body.appendChild(e)),e.textContent=Math.round(100*b)+"%",e.style.opacity="1",window.zoomIndicatorTimeout=setTimeout(()=>{e.style.opacity="0",setTimeout(()=>{e&&e.parentNode&&e.parentNode.removeChild(e)},200)},1e3)}}function X(e){b<=1||(e.preventDefault(),x=!0,C=e.clientX,E=e.clientY,S=w,M=k,P.classList.add("dragging"))}function V(e){var t;x&&(e.preventDefault(),t=e.clientX-C,e=e.clientY-E,w=S+t,k=M+e,A())}function W(e){x&&(x=!1,P.classList.remove("dragging"))}function G(e){var t;1===e.touches.length?1<b&&(x=!0,C=e.touches[0].clientX,E=e.touches[0].clientY,S=w,M=k):2===e.touches.length&&(e.preventDefault(),t=e.touches[0],e=e.touches[1],T=Math.sqrt(Math.pow(e.clientX-t.clientX,2)+Math.pow(e.clientY-t.clientY,2)))}function K(e){var t,o,a,n;1===e.touches.length&&x?(e.preventDefault(),a=e.touches[0].clientX-C,n=e.touches[0].clientY-E,w=S+a,k=M+n,A()):2===e.touches.length&&(e.preventDefault(),a=e.touches[0],n=e.touches[1],e=Math.sqrt(Math.pow(n.clientX-a.clientX,2)+Math.pow(n.clientY-a.clientY,2)),0<T&&(t=e/T,o=(a.clientX+n.clientX)/2,a=(a.clientY+n.clientY)/2,U(t,o-(n=P.getBoundingClientRect()).left,a-n.top)),T=e)}function Q(e){x=!1,T=0}function Z(){b=1,w=0,k=0,l.style.transition="transform 0.3s ease-out",A(),B(),setTimeout(()=>{l.style.transition="opacity var(--ds-duration-300) var(--ds-easing-out), transform var(--ds-duration-200) var(--ds-easing-out)"},300)}let z={closeBtn:null,prevBtn:null,nextBtn:null,backdrop:null,keyboard:null};function D(){var e=document.querySelector(".albums-modal-close-v2"),t=document.getElementById("albumsModalPrev"),o=document.getElementById("albumsModalNext"),a=document.querySelector(".albums-modal-backdrop-v2");e&&z.closeBtn&&e.removeEventListener("click",z.closeBtn),t&&z.prevBtn&&t.removeEventListener("click",z.prevBtn),o&&z.nextBtn&&o.removeEventListener("click",z.nextBtn),a&&z.backdrop&&a.removeEventListener("click",z.backdrop),z.keyboard&&document.removeEventListener("keydown",z.keyboard),y&&(z.touchStart&&y.removeEventListener("touchstart",z.touchStart),z.touchMove&&y.removeEventListener("touchmove",z.touchMove),z.touchEnd)&&y.removeEventListener("touchend",z.touchEnd),z={closeBtn:null,prevBtn:null,nextBtn:null,backdrop:null,keyboard:null,touchStart:null,touchMove:null,touchEnd:null}}function R(){var e;y?(D(),b=1,w=0,k=0,A(),B(),y.classList.remove("show"),y.classList.add("closing"),setTimeout(()=>{y.style.display="none",y.classList.remove("closing"),l.classList.remove("fade-in","slide-in-left","slide-in-right","fading","loading","zoomed"),P.classList.remove("zoomed","dragging"),q()},300),document.body.style.overflow="",window.zoomIndicatorTimeout&&(clearTimeout(window.zoomIndicatorTimeout),window.zoomIndicatorTimeout=null),(e=document.getElementById("albums-zoom-indicator"))&&e.parentNode&&e.parentNode.removeChild(e)):console.error("Modal not found")}function j(){0<s&&(s--,o(g[s].url,"left"))}function N(){s<g.length-1&&(s++,o(g[s].url,"right"))}function o(e,t){var o;l.classList.contains("fading")||l.classList.contains("loading")||(b=1,w=0,k=0,A(),B(),oe(),(o=new Image).onload=function(){l.classList.add("fading"),setTimeout(()=>{l.src=e,l.classList.remove("fading"),l.classList.add("left"===t?"slide-in-left":"slide-in-right"),q(),setTimeout(()=>{l.classList.remove("slide-in-left","slide-in-right")},300)},150)},o.onerror=function(){l.src=e,q()},o.src=e,ee(),te())}function ee(){r&&c?(r.disabled=s<=0,c.disabled=s>=g.length-1):console.error("Navigation buttons not found")}function te(){[s-2,s-1,s+1,s+2].forEach(e=>{var t;0<=e&&e<g.length&&((t=new Image).src=g[e].url,1===Math.abs(e-s)?t.loading="eager":t.loading="lazy")})}function oe(){var e=document.getElementById("albumsModalLoading");e&&e.classList.add("show")}function q(){var e=document.getElementById("albumsModalLoading");e&&e.classList.remove("show")}function ae(e){if(navigator.clipboard)navigator.clipboard.writeText(e);else{var t=document.createElement("textarea");t.value=e,t.style.position="fixed",t.style.left="-999999px",t.style.top="-999999px",document.body.appendChild(t),t.focus(),t.select();try{document.execCommand("copy"),Promise.resolve()}catch(e){return Promise.reject(e)}finally{document.body.removeChild(t)}}}function ne(e){a(e,"success")}function ie(e){a(e,"error")}function a(e,t="info"){let o=document.createElement("div");o.className="albums-message-v2 albums-message-"+t,o.textContent=e,o.style.cssText=`
            position: fixed;
            top: 20px;
            right: 20px;
            z-index: 10000;
        ...
        `,document.body.appendChild(o),setTimeout(()=>{o.style.transform="translateX(0)"},100),setTimeout(()=>{o.style.transform="translateX(100%)",setTimeout(()=>{o.parentNode&&o.parentNode.removeChild(o)},300)},3e3)}function O(e){var t=document.createElement("div");return t.textContent=e,t.innerHTML}function n(){h&&(h.disconnect(),h=null);var e=document.getElementById("albums-sentinel");e&&e.parentNode&&e.parentNode.removeChild(e),D(),y&&"none"!==y.style.display&&R(),H(),u=!1,m=!0,s=0,g=[],b=1,w=0,k=0,x=!1,v={currentPage:1,pageSize:20,totalPages:1,totalCount:0,hasNextPage:!1,pictures:[]},p=null,i=null,f=null,y=null,l=null,r=null,c=null,P=null,document.body.style.overflow=""}window.addEventListener("beforeunload",window.cleanupAlbums),window.initAlbums=function(){if(!document.querySelector(".albums-container-v2"))return!1;(h||y)&&n();try{return t(),!0}catch(e){return console.error("Failed to initialize albums:",e),!1}},window.cleanupAlbums=function(){(h||y||f)&&n()},"loading"===document.readyState?document.addEventListener("DOMContentLoaded",window.initAlbums):window.initAlbums()})();
